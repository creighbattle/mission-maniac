      ...
      <section className="bg-black px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center lg:max-w-4xl">
          <h2 className="text-base font-semibold leading-7 text-green-400 pt-20">
            Why use Mission Maniac?
          </h2>
        </div>
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-300">
          Mission Maniac provides a cost-effective / more engaging way for
          content creators and fans to connect and support each other. Compared
          to platforms like YouTube and Twitch, which charge up to 30% on
          donations, Mission Maniac charges 12% plus 30 cents per transaction.
          This means creators and fans can save or earn an additional 18% on
          each transaction.
        </p>
        <div className="flex items-center justify-center mt-10">
          <img
            className="h-40 w-40 rounded-full"
            src="/mission_maniac_savings.webp"
            alt="Mission Maniac logo"
          />
        </div>
      </section>
